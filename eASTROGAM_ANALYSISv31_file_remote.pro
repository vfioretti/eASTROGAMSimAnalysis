; eASTROGAM_ANALYSISv31_file_remote.pro - Description
; ---------------------------------------------------------------------------------
...
pro eASTROGAM_ANALYSISv31_file_remote, $
    ...
    if (isStrip) then begin
      ...
      while (1) do begin
        ...
        while(1) do begin
          ...
          if (where_compton(0) NE -1) then pair_flag_tot = [pair_flag_tot, 2] else pair_flag_tot = [pair_flag_tot, 0]
