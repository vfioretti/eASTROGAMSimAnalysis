; astrogamv3_0_geometry.pro - Description
; ---------------------------------------------------------------------------------
...
CREATE_STRUCT, AGILE3GridXTop, 'GridAGILE2XTop', ['VOLUME_ID', 'MOTHER_ID', 'TRAY_ID', 'PLANE_ID','TRK_FLAG', 'STRIP_ID', 'XPOS', 'ZPOS','E_DEP'], 'J,J,I,I,I,J,F20.5,F20.5,F20.5', DIMEN = N_ELEMENTS(Glob_vol_id_x_top)
AGILE3GridXTop.VOLUME_ID = Glob_vol_id_x_Top
AGILE3GridXTop.MOTHER_ID = Glob_moth_id_x_Top
AGILE3GridXTop.TRAY_ID = Glob_tray_id_x_Top
AGILE3GridXTop.PLANE_ID = Glob_plane_id_x_Top
AGILE3GridXTop.TRK_FLAG = Glob_Si_id_x_Top
AGILE3GridXTop.STRIP_ID = Glob_Strip_id_x_Top
AGILE3GridXTop.XPOS = Glob_pos_x_Top
AGILE3GridXTop.ZPOS = Glob_z_x_Top
AGILE3GridXTop.E_DEP = Glob_energy_dep_x_Top

HDR_XGRID_Top = ['Creator          = Valentina Fioretti', $
                 'ASTROGAM release    = V3.0']

MWRFITS, AGILE3GridXTop, './conf/ARCH.XSTRIP.TOP.ASTROGAMV3.0.TRACKER.FITS', HDR_XGRID_Top, /CREATE

CREATE_STRUCT, AGILE3GridYTop, 'GridAGILE2YTop', ['VOLUME_ID', 'MOTHER_ID', 'TRAY_ID', 'PLANE_ID','TRK_FLAG', 'STRIP_ID', 'YPOS', 'ZPOS','E_DEP'], 'J,J,I,I,I,J,F20.5,F20.5,F20.5', DIMEN = N_ELEMENTS(Glob_vol_id_y_top)
AGILE3GridYTop.VOLUME_ID = Glob_vol_id_y_Top
AGILE3GridYTop.MOTHER_ID = Glob_moth_id_y_Top
AGILE3GridYTop.TRAY_ID = Glob_tray_id_y_Top
AGILE3GridYTop.PLANE_ID = Glob_plane_id_y_Top
AGILE3GridYTop.TRK_FLAG = Glob_Si_id_y_Top
AGILE3GridYTop.STRIP_ID = Glob_Strip_id_y_Top
AGILE3GridYTop.YPOS = Glob_pos_y_Top
AGILE3GridYTop.ZPOS = Glob_z_y_Top
AGILE3GridYTop.E_DEP = Glob_energy_dep_y_Top

HDR_YGRID_Top = ['Creator          = Valentina Fioretti', $
                 'ASTROGAM release    = V3.0']

MWRFITS, AGILE3GridYTop, './conf/ARCH.YSTRIP.TOP.ASTROGAMV3.0.TRACKER.FITS', HDR_YGRID_Top, /CREATE
